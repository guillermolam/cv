...
This page covers known deployment options for Spin applications. [Please help keep this page up to date if we’ve missed one.](https://spinframework.dev/v3/contributing-docs)

## Spin command line

You can run the Spin CLI on a server just as you do on your development workstation. See the [Running Applications guide](https://spinframework.dev/running-apps) for more details.
