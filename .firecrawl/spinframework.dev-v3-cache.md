...
- [Base Directories](https://spinframework.dev/v3/cache#base-directories)
- [Plugins](https://spinframework.dev/v3/cache#plugins)
- [Templates](https://spinframework.dev/v3/cache#templates)
- [Application Cache](https://spinframework.dev/v3/cache#application-cache)
  - [Inside the Application Cache](https://spinframework.dev/v3/cache#inside-the-application-cache)
...
> Note: If you [install Spin](https://spinframework.dev/v3/install) using Homebrew, the plugins are stored at `$HOMEBREW_PREFIX/spinframework-spin/plugins` (previously `$HOMEBREW_PREFIX/fermyon-spin/plugins`).
...
> Note: If you [install Spin](https://spinframework.dev/v3/install) using Homebrew, the templates are stored at at `$HOMEBREW_PREFIX/spinframework-spin/templates` (previously `$HOMEBREW_PREFIX/fermyon-spin/templates`).
