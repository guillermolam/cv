...
- [Triggers and Components](https://spinframework.dev/v3/triggers#triggers-and-components)
  - [Mapping a Trigger to a Named Component](https://spinframework.dev/v3/triggers#mapping-a-trigger-to-a-named-component)
  - [Writing the Component Inside the Trigger](https://spinframework.dev/v3/triggers#writing-the-component-inside-the-trigger)
  - [Choosing Between the Approaches](https://spinframework.dev/v3/triggers#choosing-between-the-approaches)
  - [Setting Up Multiple Trigger Types](https://spinframework.dev/v3/triggers#setting-up-multiple-trigger-types)
- [Spin Cron Trigger](https://spinframework.dev/v3/triggers#spin-cron-trigger)
  - [Cron Trigger Expressions](https://spinframework.dev/v3/triggers#cron-trigger-expressions)
  - [Installing the Cron Trigger Plugin](https://spinframework.dev/v3/triggers#installing-the-cron-trigger-plugin)
  - [Installing the Cron Trigger Template](https://spinframework.dev/v3/triggers#installing-the-cron-trigger-template)
  - [Creating the Web Application](https://spinframework.dev/v3/triggers#creating-the-web-application)
  - [Inspecting the Source Code](https://spinframework.dev/v3/triggers#inspecting-the-source-code)
  - [Building and Running the Application](https://spinframework.dev/v3/triggers#building-and-running-the-application)
...
How events are specified depends on the type of trigger involved. For example, an [HTTP trigger](https://spinframework.dev/v3/http-trigger) is specified by the route it handles. A [Cron Trigger](https://spinframework.dev/v3/triggers#spin-cron-trigger) is specified by the schedule on which it runs. A [Redis trigger](https://spinframework.dev/v3/redis-trigger) is specified by the channel it monitors. A trigger always, however, has a `component` field, specifying the component that handles matching events. The `component` can be specified in two ways.
