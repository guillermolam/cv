...
- ** CI/CD & GitOPS: ** Tuberías codificadas con ** Githubacciones **, ** Biblioteca compartida
  ...
  argocd/rollouts **; Calidad de IAC forzada y controles de costos a través de ** tflint **, **
  tfsec **, ** checkov **, ** trunk.io **; Sast Gates incrustado (** Snyk **, ** Semgrep **) y el
  escaneo integrado ** de imagen de contenedores ** (Trivy, Clair, ECR/ACR); 0
