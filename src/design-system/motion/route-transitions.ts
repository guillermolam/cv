...
export const ROUTE_TRANSITION_NAMES = [
  'none',
  'fade',
  'phosphor-wipe',
] as const;
...
export const getRouteTransitionConfig = (
  name: RouteTransitionName = 'phosphor-wipe',
...
export const prepareRouteTransitionElement = (
...
export const cleanupRouteTransitionElement = (
  element: HTMLElement | null | undefined,
) => {
  if (!element) return;
