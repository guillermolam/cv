...
export default defineConfig({
  ...
  presets: [
    ...
    // Icon system: i-ph-* (Phosphor) and i-local-* (local SVGs)
  ...
  shortcuts: [
    ...
    [
      'ds-btn',
      'inline-flex items-center justify-center gap-[var(--ds-space-2)] border border-[var(--color-border)] rounded-pill px-[var(--ds-space-4)] h-[2.5rem] text-1 text-[var(--color-text)] bg-[color-mix(in_oklab,var(--color-surface-2),transparent_12%)] no-underline cursor-pointer transition-all duration-fast ease-standard',
    ],
    [
      'ds-btn-primary',
    ...
    [
      'ds-label',
      'text-00 tracking-[0.06em] uppercase text-[var(--color-text-muted)] leading-[1.4]',
    ],
    [
      'ds-eyebrow',
      'text-00 tracking-[0.08em] uppercase text-[var(--color-text-muted)] mb-[var(--ds-space-2)]',
    ],
    [
      'ds-heading',
